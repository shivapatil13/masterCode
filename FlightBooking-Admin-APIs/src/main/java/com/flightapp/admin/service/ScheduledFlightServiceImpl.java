...
import com.flightapp.admin.repo.FlightScheduledRepo;
import com.flightapp.admin.repo.ScheduledRepo;
...
public class ScheduledFlightServiceImpl implements ScheduledFlightService {
	...
	@Autowired
	private FlightScheduledRepo flightScheduledRepo;

	@Autowired
	private ScheduledRepo scheduleRepo;
	...
	public ScheduledFlight addScheduledFlight(ScheduledFlight scheduledFlight) {
		return flightScheduledRepo.save(scheduledFlight);
	}
	...
	public ScheduledFlight modifyScheduledFlight(ScheduledFlight scheduleFlight) {
		ScheduledFlight updateScheduleFlight = flightScheduledRepo.findById(scheduleFlight.getScheduleFlightId()).get();
		...
		flightScheduledRepo.save(updateScheduleFlight);
	...
	public String removeScheduledFlight(BigInteger flightId) throws RecordNotFoundException {
		...
		Optional<ScheduledFlight> scheduleFlight = flightScheduledRepo.findById(flightId);
		if (!scheduleFlight.isPresent())
			...
			// }
			flightScheduledRepo.deleteById(flightId);
		}
	...
	public Iterable<ScheduledFlight> viewAllScheduledFlights() {
		return flightScheduledRepo.findAll();
	}
